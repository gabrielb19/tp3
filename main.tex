...
Al observar los F1 en \ref{tab:f1_splits_vit}, se puede observar que los splits poseen valores menores comparados con los obtenidos a través de ResNet y VGG, esto evidenciado tanto por puntajes menores como por un promedio de $0.7889$ y una desviación estándar de $0.0869$. El rendimiento inferior tambien podría explicarse a través que en terminos de requerir datos, los transformadores como arquitectura requieren de más datos que los métodos convencionales de redes profundas.
...
Al observar las curvas (figura \ref{fig:vit_train_val_splits}), se repite el comportamiento previamente observado de ViT que es el método que tiene una pendiente decreciente más consistente y suave comparado con ResNet y ViT, pero en las curvas de validación se ve que entre modelos, hay cierto rango de dispersión.
...
Al analizar las matrices de confusión (figura \ref{fig:2_matrix_vit}), se repiten los comportamientos previamente descritos de problemas en clasificación, pero ahora también sucede con la clase normal, por lo que en general resulta en una peor clasificación.
